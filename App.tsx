              ...
              {showCorsGuide && !isSimulationMode && (
                <div className="bg-amber-50 border border-amber-200 rounded-xl p-5 shadow-sm animate-in fade-in zoom-in-95">
                  ...
                  <p className="text-sm text-amber-700 mb-3 leading-relaxed">
                    The browser blocked the request to <b>127.0.0.1:8000</b>. This is usually due to missing <b>CORS</b> configuration in your Python backend.
                  </p>
                  <p className="text-xs font-semibold text-slate-600 mb-2 uppercase tracking-wide">Add this to your Python file:</p>
...
app.add_middleware(
    ...
    allow_headers=["*"],
                  ...
                  <p className="text-xs text-amber-600 mt-3">
                    Restart your Python server after adding these lines.
                  </p>
                </div>
              )}
                ...
                <div className="bg-slate-900 text-slate-300 rounded-xl p-6 shadow-md border border-slate-800">
                  ...
                  <div className="space-y-3 text-sm">
                    <div className="flex justify-between items-center py-1 border-b border-slate-800">
                      ...
                      <code className="text-xs bg-slate-800 px-2 py-1 rounded text-blue-300">127.0.0.1:8000</code>
                    </div>
                    <div className="flex justify-between items-center py-1 border-b border-slate-800">
                      <span>Mode</span>
